...
from GridCal.Engine.Core.snapshot_opf_data import compile_opf_snapshot_circuit, SnapshotOpfData
...
class OptimalNetTransferCapacitySnapshotDriver(DriverTemplate):
    ...
    def opf(self):
        ...
        numerical_circuit = compile_opf_snapshot_circuit(
            circuit=self.grid,
