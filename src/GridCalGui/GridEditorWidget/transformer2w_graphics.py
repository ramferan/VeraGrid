...
from PySide6.QtWidgets import QDialog, QDoubleSpinBox, QLabel, QPushButton, QComboBox, QVBoxLayout, QGraphicsLineItem, QGraphicsRectItem, QMenu, QGraphicsEllipseItem
