...
import GridCalGui.Visualization.visualization as viz
...
# GUI imports
import GridCalGui.Session.export_results_driver as exprtdrv
import GridCalGui.Session.file_handler as filedrv
import GridCalGui.Session.synchronization_driver as syncdrv
from GridCalGui.Analysis.AnalysisDialogue import GridAnalysisGUI
from GridCalGui.BusViewer.bus_viewer_dialogue import BusViewerGUI
from GridCalGui.CoordinatesInput.coordinates_dialogue import CoordinatesInputGUI
from GridCalGui.GIS.gis_dialogue import GISWindow
from GridCalGui.GeneralDialogues import *
from GridCalGui.GridGenerator.grid_generator_dialogue import GridGeneratorGUI
from GridCalGui.Main.object_select_window import ObjectSelectWindow
from GridCalGui.Main.MainWindow import Ui_mainWindow, QMainWindow
from GridCalGui.ProfilesInput.profile_dialogue import ProfileInputGUI
from GridCalGui.SigmaAnalysis.sigma_analysis_dialogue import SigmaAnalysisGUI
from GridCalGui.SyncDialogue.sync_dialogue import SyncDialogueWindow
from GridCalGui.TowerBuilder.LineBuilderDialogue import TowerBuilderGUI
from GridCalGui.Session.session import SimulationSession
from GridCalGui.AboutDialogue.about_dialogue import AboutDialogueGuiGUI
from GridCalGui.GridEditorWidget.editor import GridEditor
from GridCalGui.GuiFunctions import *
from GridCal.__version__ import __GridCal_VERSION__

try:
    from GridCalGui.ConsoleWidget import ConsoleWidget
    qt_console_available = True
except ModuleNotFoundError:
    print('No qtconsole available')
    qt_console_available = False

from PySide6.QtWidgets import QFileDialog, QPushButton, QComboBox, QVBoxLayout, QGraphicsLineItem, QGraphicsRectItem, QMenu, QMessageBox
from PySide6.QtCore import QLineF, QPoint, QRectF
from PySide6.QtGui import QIcon, QImage, QBrush, QPixmap, QCursor, Qt, QPen, QColor, QStandardItemModel, QStandardItem
from GridCalGui.GridEditorWidget.generic_graphics import ACTIVE, DEACTIVATED, FONT_SCALE, EMERGENCY, OTHER
from GridCalGui.GridEditorWidget.messages import error_msg, yes_no_question, warning_msg, info_msg
...
def run(use_native_dialogues=False):
    ...
    :return:
    """
    # from GridCal.GridCalGui.themes import QDarkPalette
