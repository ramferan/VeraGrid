...
from VeraGrid.Gui.ProfilesInput.profiles_from_data_gui import Ui_Dialog
...
from VeraGridEngine.Devices.Parents.editable_device import uuid2idtag, GCProp
from VeraGridEngine.Devices.multi_circuit import MultiCircuit
from VeraGridEngine.basic_structures import Mat, BoolVec, Logger
...
def check_similarity(name_to_search: str,
    ...
    :param name_to_search: name of the VeraGrid object
    :param code_to_search: code (secondary id) of the VeraGrid object
...
class ProfileInputGUI(QtWidgets.QDialog):
    ...
    def get_multiplier(self) -> float:
        ...
        Remember that the power units in VeraGrid are the MVA
        """
